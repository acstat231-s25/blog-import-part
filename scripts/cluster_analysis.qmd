...
# iterate through clustering algorithm for 15 different values of k
elbow_plot <- tibble(k = 1:15) |>
  mutate(
    kmeans_results = purrr::map(k, ~ kmeans(game_standardized, .x, nstart=20)),
