...
genres - Type of game.
user_score - Numeric score out of 100 from a given equation which uses user's reviews
...
games_clean <- games_string |>
  mutate(across(c(required_age, price, dlc_count,
